  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        {/* Core Star */}
        <div className="relative w-20 h-20 rounded-full bg-gradient-to-tr from-primary/20 via-foreground/90 to-primary-glow/40 shadow-[0_0_80px_rgba(99,102,241,0.3)] z-20">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[380px] h-[380px] orbital-path">
          <div className="orbit-container-fast absolute inset-0">
            ...
            <div className="absolute bottom-[20%] left-[10%] w-0.5 h-0.5 rounded-full bg-foreground/60" />
          </div>
        </div>

        {/* Static Stars */}
        <div className="absolute inset-0 animate-[spin_100s_linear_infinite] opacity-30">
          <div className="absolute top-10 left-40 w-0.5 h-0.5 bg-foreground rounded-full" />
          <div className="absolute bottom-20 right-10 w-1 h-1 bg-primary/30 rounded-full blur-[0.5px]" />
          <div className="absolute top-60 left-0 w-0.5 h-0.5 bg-foreground rounded-full" />
        </div>
      </div>

      <div className="absolute bottom-12 left-0 right-0 text-center">
        <span className="text-muted-foreground font-light text-xs tracking-[0.4em] uppercase opacity-40">
