...
export const AuthVisuals: React.FC<AuthVisualsProps> = ({ 
  alignment = "right", 
  className 
}) => {
  return (
    <div 
      className={cn(
        "hidden md:block w-1/2 bg-[#020203] relative overflow-hidden",
    ...
    >
      ...
      {/* Meteor Streaks */}
      <div className="meteor-streak top-20 left-10" style={{ animationDelay: "0s" }} />
      <div className="meteor-streak top-[60%] left-[40%]" style={{ animationDelay: "5s" }} />
      <div className="meteor-streak top-[20%] left-[80%]" style={{ animationDelay: "8s" }} />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        {/* Core Star */}
        <div className="relative w-20 h-20 rounded-full bg-gradient-to-tr from-indigo-100 via-white/90 to-indigo-300 shadow-[0_0_80px_rgba(99,102,241,0.3)] z-20">
          <div className="absolute inset-0 rounded-full bg-indigo-500 mix-blend-overlay opacity-30" />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[240px] h-[240px] orbital-path">
          <div className="orbit-container absolute inset-0">
            <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-indigo-300/60 shadow-[0_0_15px_rgba(165,180,252,0.4)] motion-blur-sphere" />
            <div className="absolute top-1/2 -right-1 w-1 h-1 rounded-full bg-slate-400/80" />
          </div>
        </div>
        ...
        <div className="absolute inset-0 animate-[spin_100s_linear_infinite] opacity-30">
          ...
          <div className="absolute bottom-20 right-10 w-1 h-1 bg-indigo-200 rounded-full blur-[0.5px]" />
