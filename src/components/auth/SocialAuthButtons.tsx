  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        ...
        className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#151518] hover:bg-[#1C1C21] border border-white/[0.05] rounded-xl transition-all active:scale-[0.98] disabled:opacity-50 group"
      >
