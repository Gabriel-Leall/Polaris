    ...
    <div className="@container w-full py-20">
      <div className="flex flex-col items-center justify-center gap-8 text-center"
        ...
        <p className="text-indigo-200/70 text-lg font-light tracking-wide font-mono max-w-2xl">
          Sem distrações. Apenas foco. Uma experiência de produtividade imersiva.
        </p>
        ...
        <div 
          ...
          <div className="relative w-full rounded-3xl overflow-hidden aspect-[16/9] border border-white/10 transition-transform duration-500 ease-out"
               style={{
