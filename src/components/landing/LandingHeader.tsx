...
export const LandingHeader = () => {
  ...
  return (
    <div className={`w-full flex justify-center sticky top-0 z-50 transition-all duration-300 ${
      isScrolled 
        ? 'backdrop-blur-md bg-[main]/80 border-b border-[rgba(255,255,255,0.1)]' 
        : 'bg-transparent'
    }`}>
      <div className="w-full max-w-[1280px] px-6 py-4">
        <header className="flex items-center justify-between whitespace-nowrap">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link 
              href="/signup"
              className="bg-[primary] hover:bg-[primary-glow] text-white px-6 py-2.5 rounded-full font-semibold text-sm transition-all duration-200 shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:shadow-[0_0_25px_rgba(99,102,241,0.6)] hover:scale-105"
            >
              Get Started
            </Link>
          </div>
