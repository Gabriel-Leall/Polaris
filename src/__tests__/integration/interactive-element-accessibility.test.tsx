...
function hasProperFocusStyles(componentCode: string): boolean {
  ...
  const hasFocusVisible = componentCode.includes('focus-visible:outline-none') &&
    (componentCode.includes('focus-visible:ring-2') || componentCode.includes('focus-visible:ring-1') || componentCode.includes('focus-visible:ring')) &&
    (componentCode.includes('focus-visible:ring-primary') || componentCode.includes('focus-visible:ring-ring'))
