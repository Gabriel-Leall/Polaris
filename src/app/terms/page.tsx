      ...
      <main className="container mx-auto px-6 py-16 max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-white/70 leading-relaxed">
          <section className="space-y-4">
            ...
            <p>
              By accessing and using Axis (&quot;the Service&quot;), you agree
          ...
          <section className="space-y-4">
            ...
            <p>
              Axis grants you a personal, non-exclusive, non-transferable
              license to use the Service for personal or professional
              productivity purposes. You may not:
            </p>
          ...
          <section className="space-y-4">
            ...
            <p>
              Axis integrates with third-party services like Notion and Google
              Gemini. Your use of these integrations is also subject to their
              respective terms of service. We are not responsible for the
              availability or conduct of these third-party platforms.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              The materials on Axis are provided on an &apos;as is&apos; basis.
              Axis makes no warranties, expressed or implied, and hereby
          ...
          <section className="space-y-4">
            ...
            <p>
              In no event shall Axis or its suppliers be liable for any damages
